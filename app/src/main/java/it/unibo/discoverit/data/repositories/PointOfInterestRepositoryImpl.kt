...
class PointOfInterestRepositoryImpl(
    ...
    override suspend fun getPOIsByCategory(categoryId: Long): List<PointOfInterest> {
        return poiDAO.getAllByCategory(categoryId)
    }

    override suspend fun getPOIDetails(poiId: Long): PointOfInterest? {
        return poiDAO.getById(poiId)
    }

    override suspend fun toggleVisit(userId: Long, poiId: Long) {
    ...
    override suspend fun isVisited(userId: Long, poiId: Long): Boolean {
