...
class UserRepositoryImpl(
    ...
    override fun getFriendsAndCountCompletedAchievements(userId: Long): Flow<Map<User, Long>> =
    ...
    override suspend fun removeFriendship(userId: Long, friendId: Long) {
    ...
    override fun getCountCompletedAchievements(userId: Long): Flow<Long> {
        return userDao.getCountCompletedAchievements(userId)
    }
}
