...
class SettingsRepositoryImpl(
    ...
    override suspend fun setTheme(theme: ThemeOption) { dataStore.edit { it[THEME_KEY] = theme.name } }
    override suspend fun setNotificationsEnabled(enabled: Boolean) { dataStore.edit { it[NOTIFICATIONS_KEY] = enabled } }
    override suspend fun setBiometricLoginEnabled(enabled: Boolean) { dataStore.edit { it[BIOMETRIC_LOGIN_KEY] = enabled } }
}